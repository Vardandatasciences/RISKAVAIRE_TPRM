        ...
        <div class="card" v-if="selectedQuestionnaireData">
          ...
          <div class="card-content space-y-6">
            ...
            <div class="global-form-group">
              <label class="global-form-label" for="reviewComment">Overall Review Comment</label>
            ...
            >
              <div v-if="isSubmittingReview" class="loading-spinner-sm mr-2"></div>
...
const submitReviewComment = async () => {
  ...
  try {
    ...
    const response = await http.put(`/api/tprm/v1/bcpdrp/questionnaires/${selectedQuestionnaireId.value}/review/`, reviewData)
...
const fetchQuestionnaires = async () => {
  ...
  try {
    console.log('Fetching questionnaires from API endpoint: /api/tprm/v1/bcpdrp/questionnaires/')
