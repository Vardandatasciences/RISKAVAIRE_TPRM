      ...
      <div class="card">
        ...
        <div class="card-content p-0">
          ...
          <div v-else class="overflow-x-hidden">
            <table class="approval-table table-fixed w-full">
              <thead>
                <tr>
                  <th class="w-[5%]">ID</th>
                  <th class="w-[17%]">Workflow Name</th>
                  <th class="w-[7%]">Plan Type</th>
                  <th class="w-[11%]">Object Type</th>
                  <th class="w-[7%]">Object ID</th>
                  <th class="w-[9%]">Assigner</th>
                  <th class="w-[9%]">Assignee</th>
              ...
              <tbody>
                <tr v-for="approval in approvals" :key="approval.approval_id">
                  <td class="break-words">{{ approval.approval_id }}</td>
                  <td class="font-medium break-words">{{ approval.workflow_name }}</td>
                  <td class="break-words">{{ approval.plan_type }}</td>
                  <td class="break-words">{{ approval.object_type }}</td>
                  <td class="break-words">{{ approval.object_id }}</td>
                  <td class="break-words">{{ approval.assigner_name }}</td>
                  <td class="break-words">{{ approval.assignee_name }}</td>
                  <td class="whitespace-nowrap">
                    <span :class="getStatusBadgeClass(approval.status)">
                      {{ formatStatusText(approval.status) }}
                    </span>
                  </td>
                  <td class="break-words whitespace-nowrap">{{ formatDate(approval.assigned_date) }}</td>
                  <td class="break-words whitespace-nowrap">{{ formatDate(approval.due_date) }}</td>
                  <td>
                    <div class="flex gap-2 flex-wrap">
                      <button 
                        @click="viewApprovalDetails(approval)" 
                        class="button button--view text-xs whitespace-nowrap" 
                        title="View Details"
                      >
                        View
                      </button>
            ...
            <form @submit.prevent="createAssignment" class="space-y-6">
              ...
              <div class="form-grid-3">
                <div class="space-y-2">
                  ...
                  <select v-model="form.plan_type" id="planType" class="global-form-select" required>
          ...
          <div v-else-if="approvalDetails">
            ...
            <div class="details-section">
              ...
              <div class="details-grid">
                ...
                <div class="detail-item">
                  <label>Status:</label>
                  <span :class="getStatusBadgeClass(approvalDetails.status)">
                    {{ formatStatusText(approvalDetails.status) }}
                  </span>
                </div>
                <div class="detail-item">
            ...
            <div v-if="approvalDetails.object_type === 'PLAN EVALUATION'" class="details-section">
              ...
              <div v-if="planInfo" class="plan-info">
                ...
                <div class="detail-item">
                  <label>Status:</label>
                  <span :class="getStatusBadgeClass(planInfo.status)">
                    {{ formatStatusText(planInfo.status) }}
                  </span>
                </div>
                <div class="detail-item">
            ...
            <div v-if="approvalDetails.object_type === 'NEW QUESTIONNAIRE' && questionnaireDetails" class="details-section">
              ...
              <div class="questionnaire-info">
                ...
                <div class="detail-item">
                  <label>Status:</label>
                  <span :class="getStatusBadgeClass(questionnaireDetails.status)">
                    {{ formatStatusText(questionnaireDetails.status) }}
                  </span>
                </div>
                <div class="detail-item">
              ...
              <div v-if="questionnaireResponses.length > 0" class="responses-section">
                ...
                <div v-for="response in questionnaireResponses" :key="response.response_id" class="response-card">
                  <div class="response-header">
                    ...
                    <span :class="getStatusBadgeClass(response.status)">
                      {{ formatStatusText(response.status) }}
                    </span>
                  </div>
            ...
            <div v-if="approvalDetails.object_type === 'QUESTIONNAIRE RESPONSE' && assignmentResponseDetails" class="details-section">
              ...
              <div class="assignment-info">
                ...
                <div class="detail-item">
                  <label>Status:</label>
                  <span :class="getStatusBadgeClass(assignmentResponseDetails.status)">
                    {{ formatStatusText(assignmentResponseDetails.status) }}
                  </span>
                </div>
                <div class="detail-item">
                  <label>Assigned Date:</label>
                ...
                <div class="responses-list">
                  <div v-for="(response, questionId) in assignmentResponseDetails.questions_data" :key="questionId" class="response-card">
                    <div class="response-header">
                      ...
                      <span :class="getStatusBadgeClass(getResponseStatus(response))">
                        {{ formatStatusText(getResponseStatus(response)) }}
                      </span>
                    </div>
