        ...
        <div class="form-grid-5">
          ...
          <div class="space-y-2">
            ...
            <SingleSelectDropdown
              ...
              :placeholder="isLoadingUsers ? 'Loading users...' : 'All Users'"
              height="2.5rem"
              width="12rem"
...
export default {
  ...
  setup() {
    ...
    const userFilterOptions = computed(() => {
      return [
        { value: '', label: isLoadingUsers.value ? 'Loading users...' : 'All Users' },
    ...
    const objectTypeFilterOptions = [
      ...
      { value: 'ASSIGNMENT_RESPONSE', label: 'Assignment Response' }
    ]
    ...
    const getStatusBadgeClass = (status) => {
      ...
      if (statusUpper === 'ASSIGNED') {
        ...
        return 'badge-active'
      } else if (statusUpper === 'PENDING' || statusUpper === 'PENDING_ASSIGNMENT') {
