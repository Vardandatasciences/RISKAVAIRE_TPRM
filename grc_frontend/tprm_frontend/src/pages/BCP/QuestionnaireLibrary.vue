<template>
  <div class="min-h-screen bg-background questionnaire-library-page">
    <div class="container mx-auto p-6 space-y-6">
      ...
      <div class="flex flex-col space-y-4">
        <div class="flex items-center justify-between">
          ...
          <div class="flex gap-2">
            <button class="button button--create" @click="navigateToQuestionnaireWorkflow">
      ...
      <div v-else class="questionnaire-table-section">
        <div class="questionnaire-table-header">
          <h3 class="questionnaire-table-title">Questionnaire Catalog</h3>
          <p class="questionnaire-table-description">All questionnaires in the system</p>
        </div>
        <div class="questionnaire-table-content">
          <div class="table-container overflow-x-hidden">
            <table class="table table-fixed w-full">
              ...
              <tr>
                ...
                <th style="width: 11%;">Tags</th>
                <th style="width: 8%;">Used By</th>
              ...
              <tbody>
                ...
                <tr v-else v-for="questionnaire in filteredQuestionnaires" :key="questionnaire.questionnaire_id">
                  <td class="font-medium id-cell">{{ questionnaire.questionnaire_id }}</td>
                  <td class="break-words">{{ questionnaire.title }}</td>
                  <td class="break-words">{{ questionnaire.version }}</td>
                  <td>
                    <span :class="getStatusBadgeClass(questionnaire.status)">
                      {{ formatStatusText(questionnaire.status) }}
                    </span>
                  </td>
                  <td>
                  ...
                  <td class="break-words">{{ questionnaire.owner }}</td>
                  <td class="break-words">{{ questionnaire.questionCount }}</td>
                  <td>
                  ...
                  <td class="break-words">{{ questionnaire.assignments }}</td>
                  <td class="break-words">{{ questionnaire.updated }}</td>
                  <td>
                    <div class="flex gap-1 flex-wrap">
                      <button class="button button--view" @click="handleViewDetails(questionnaire)" title="View Details">
                        View
                      </button>
                      <button type="button" class="button button--assign" @click="handleAssign(questionnaire)" title="Assign Questionnaire">
                        Assign
                      </button>
        ...
        <div class="bg-card rounded-lg max-w-4xl max-h-[90vh] overflow-y-auto m-4">
          ...
          <div class="card-content space-y-6 p-4">
            ...
            <div class="grid grid-cols-2 gap-6">
              <div class="space-y-3">
                ...
                <div>
                  ...
                  <span :class="getStatusBadgeClass(selectedQuestionnaire.status)">
                    {{ formatStatusText(selectedQuestionnaire.status) }}
                  </span>
                </div>
              </div>
              <div class="space-y-3">
            ...
            <div class="flex gap-2 pt-4 border-t">
              <button type="button" class="button button--assign" @click="handleAssign(selectedQuestionnaire)">
                Assign
              </button>
...
const ownerFilterOptions = [
  { value: "ALL", label: "Any" },
  { value: "ME", label: "Me" },
  { value: "Owner A", label: "Owner A" },
  { value: "Owner B", label: "Owner B" },
  { value: "Owner C", label: "Owner C" },
  { value: "Owner D", label: "Owner D" },
  { value: "Owner E", label: "Owner E" }
]
...
const getStatusBadgeClass = (status: string) => {
  ...
  } else if (statusUpper === 'IN_REVIEW' || statusUpper === 'IN REVIEW') {
