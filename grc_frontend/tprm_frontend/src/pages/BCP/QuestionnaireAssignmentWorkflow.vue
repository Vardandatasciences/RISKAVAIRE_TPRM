          ...
          <form @submit.prevent="submitQuestionnaireAssignment" class="space-y-6">
            ...
            <div class="global-form-row">
              <div class="global-form-group">
                <label class="global-form-label" for="selectQuestionnaire">Select Questionnaire <span class="global-form-label-required">*</span></label>
                <select class="global-form-select" v-model="assignmentForm.questionnaire_id" id="selectQuestionnaire" required>
              ...
              <div class="global-form-group">
                <label class="global-form-label" for="assignTo">Assign To <span class="global-form-label-required">*</span></label>
                <select class="global-form-select" v-model="assignmentForm.assigned_to_user_id" id="assignTo" required>
              ...
              <div class="global-form-group">
                <label class="global-form-label" for="dueDate">Due Date <span class="global-form-label-required">*</span></label>
                <input class="global-form-date-input" type="date" id="dueDate" v-model="assignmentForm.due_date" required />
              </div>
            </div>
      ...
      <div v-if="showSuccess" class="card bg-green-50 border border-green-200">
        <div class="card-content">
          ...
          <div class="mt-4 flex gap-2">
            ...
            <button @click="viewAssignments" class="button button--view">
              View Assignments
            </button>
          </div>
        </div>
...
const fetchPlans = async () => {
  ...
  try {
    ...
    const response = await http.get('/api/tprm/v1/bcpdrp/plans/')
...
const submitQuestionnaireAssignment = async () => {
  try {
    ...
    const response = await http.post('/api/tprm/v1/bcpdrp/questionnaires/assign/', {
...
<style>
/* Color Blindness Overrides - Preserve Original Colors */
...
html:not(.dark-theme)[data-colorblind="protanopia"] .breadcrumb-item--active,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .breadcrumb-item--active,
html:not(.dark-theme)[data-colorblind="tritanopia"] .breadcrumb-item--active {
  background: hsl(var(--primary)) !important;
  color: hsl(var(--primary-foreground)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .breadcrumb-item--active:hover,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .breadcrumb-item--active:hover,
html:not(.dark-theme)[data-colorblind="tritanopia"] .breadcrumb-item--active:hover {
  background: hsl(var(--primary) / 0.9) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .breadcrumb-item--active .breadcrumb-icon,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .breadcrumb-item--active .breadcrumb-icon,
html:not(.dark-theme)[data-colorblind="tritanopia"] .breadcrumb-item--active .breadcrumb-icon {
  background: hsl(var(--primary-foreground)) !important;
  color: hsl(var(--primary)) !important;
}

/* Button Colors */
html:not(.dark-theme)[data-colorblind="protanopia"] .button--create,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .button--create,
html:not(.dark-theme)[data-colorblind="tritanopia"] .button--create {
  background-color: hsl(var(--primary)) !important;
  color: hsl(var(--primary-foreground)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .button--create:hover,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .button--create:hover,
html:not(.dark-theme)[data-colorblind="tritanopia"] .button--create:hover {
  background-color: hsl(var(--primary) / 0.9) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .button--view,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .button--view,
html:not(.dark-theme)[data-colorblind="tritanopia"] .button--view {
  background-color: hsl(var(--primary)) !important;
  color: hsl(var(--primary-foreground)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .button--view:hover,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .button--view:hover,
html:not(.dark-theme)[data-colorblind="tritanopia"] .button--view:hover {
  background-color: hsl(var(--primary) / 0.9) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .button--back,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .button--back,
html:not(.dark-theme)[data-colorblind="tritanopia"] .button--back {
  background-color: transparent !important;
  color: hsl(var(--foreground)) !important;
  border-color: hsl(var(--border)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .button--back:hover,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .button--back:hover,
html:not(.dark-theme)[data-colorblind="tritanopia"] .button--back:hover {
  background-color: hsl(var(--muted)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .btn--outline,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .btn--outline,
html:not(.dark-theme)[data-colorblind="tritanopia"] .btn--outline {
  border-color: hsl(var(--border)) !important;
  color: hsl(var(--foreground)) !important;
  background-color: transparent !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .btn--outline:hover,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .btn--outline:hover,
html:not(.dark-theme)[data-colorblind="tritanopia"] .btn--outline:hover {
  background-color: hsl(var(--muted)) !important;
}

/* Badge Colors */
html:not(.dark-theme)[data-colorblind="protanopia"] .badge--success,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .badge--success,
html:not(.dark-theme)[data-colorblind="tritanopia"] .badge--success {
  background-color: hsl(var(--success)) !important;
  color: hsl(var(--success-foreground)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .badge--default,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .badge--default,
html:not(.dark-theme)[data-colorblind="tritanopia"] .badge--default {
  background-color: hsl(var(--primary)) !important;
  color: hsl(var(--primary-foreground)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .badge--secondary,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .badge--secondary,
html:not(.dark-theme)[data-colorblind="tritanopia"] .badge--secondary {
  background-color: hsl(var(--secondary)) !important;
  color: hsl(var(--secondary-foreground)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .badge--destructive,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .badge--destructive,
html:not(.dark-theme)[data-colorblind="tritanopia"] .badge--destructive {
  background-color: hsl(var(--destructive)) !important;
  color: hsl(var(--destructive-foreground)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .badge--warning,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .badge--warning,
html:not(.dark-theme)[data-colorblind="tritanopia"] .badge--warning {
  background-color: hsl(var(--warning)) !important;
  color: hsl(var(--warning-foreground)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .badge--neutral,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .badge--neutral,
html:not(.dark-theme)[data-colorblind="tritanopia"] .badge--neutral {
  background-color: hsl(var(--muted)) !important;
...
/* Mini Badge Colors */
html:not(.dark-theme)[data-colorblind="protanopia"] .mini-badge.badge--default,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .mini-badge.badge--default,
html:not(.dark-theme)[data-colorblind="tritanopia"] .mini-badge.badge--default {
  background-color: hsl(var(--primary)) !important;
  color: hsl(var(--primary-foreground)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .mini-badge.badge--secondary,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .mini-badge.badge--secondary,
html:not(.dark-theme)[data-colorblind="tritanopia"] .mini-badge.badge--secondary {
  background-color: hsl(var(--secondary)) !important;
  color: hsl(var(--secondary-foreground)) !important;
}

/* Card Backgrounds */
html:not(.dark-theme)[data-colorblind="protanopia"] .card,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .card,
html:not(.dark-theme)[data-colorblind="tritanopia"] .card {
  background-color: hsl(var(--card)) !important;
  border-color: hsl(var(--border)) !important;
}

/* Input Fields */
html:not(.dark-theme)[data-colorblind="protanopia"] .input,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .input,
html:not(.dark-theme)[data-colorblind="tritanopia"] .input {
  background-color: hsl(var(--background)) !important;
  border-color: hsl(var(--border)) !important;
  color: hsl(var(--foreground)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .input:focus,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .input:focus,
html:not(.dark-theme)[data-colorblind="tritanopia"] .input:focus {
  border-color: hsl(var(--ring)) !important;
}

/* Select Dropdowns */
html:not(.dark-theme)[data-colorblind="protanopia"] .global-form-select,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .global-form-select,
html:not(.dark-theme)[data-colorblind="tritanopia"] .global-form-select {
  background-color: hsl(var(--background)) !important;
  border-color: hsl(var(--border)) !important;
  color: hsl(var(--foreground)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .modern-trigger,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .modern-trigger,
html:not(.dark-theme)[data-colorblind="tritanopia"] .modern-trigger {
  background-color: hsl(var(--background)) !important;
  border-color: hsl(var(--border)) !important;
  color: hsl(var(--foreground)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .modern-trigger:hover,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .modern-trigger:hover,
html:not(.dark-theme)[data-colorblind="tritanopia"] .modern-trigger:hover {
  border-color: hsl(var(--ring)) !important;
}

/* Table Dropdown Menu */
html:not(.dark-theme)[data-colorblind="protanopia"] .table-dropdown-menu,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .table-dropdown-menu,
html:not(.dark-theme)[data-colorblind="tritanopia"] .table-dropdown-menu {
  background-color: hsl(var(--background)) !important;
  border-color: hsl(var(--border)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .table-header,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .table-header,
html:not(.dark-theme)[data-colorblind="tritanopia"] .table-header {
  background-color: hsl(var(--muted)) !important;
  border-bottom-color: hsl(var(--border)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .plans-table th,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .plans-table th,
html:not(.dark-theme)[data-colorblind="tritanopia"] .plans-table th {
  background-color: hsl(var(--muted)) !important;
  color: hsl(var(--muted-foreground)) !important;
  border-bottom-color: hsl(var(--border)) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .plan-row:hover,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .plan-row:hover,
html:not(.dark-theme)[data-colorblind="tritanopia"] .plan-row:hover {
  background-color: hsl(var(--muted) / 0.5) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .plan-row.selected,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .plan-row.selected,
html:not(.dark-theme)[data-colorblind="tritanopia"] .plan-row.selected {
