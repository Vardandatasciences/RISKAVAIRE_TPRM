<template>
  <div v-if="!audit" class="flex items-center justify-center min-h-[400px] p-4">
    <Card class="w-full max-w-md text-center">
      <CardContent class="p-6">
        ...
        <button type="button" @click="navigateToMyAudits" class="button button--back">
          Back to My Audits
        </button>
      </CardContent>
    </Card>
  ...
  <div v-else class="max-w-7xl mx-auto space-y-4 lg:space-y-6 p-4 lg:p-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
      <button type="button" @click="navigateToMyAudits" class="button button--back w-full sm:w-auto">
        Back to My Audits
      </button>
      ...
      <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
        ...
        <template v-if="audit.status === 'created'">
          <button
            ...
            :disabled="isLoading"
            class="button button--start w-full sm:w-auto"
          >
        ...
        <template v-else-if="audit.status === 'in_progress'">
          <button
            ...
            :disabled="isLoading"
            class="button button--save gap-2 w-full sm:w-auto"
          >
            <Save class="w-4 h-4" />
            Save Progress
          </button>
          <button
            ...
            class="button button--submit gap-2 w-full sm:w-auto"
          >
            <Send class="w-4 h-4" />
            Submit for Review
          </button>
        ...
        <template v-else>
          <button
            ...
            class="button button--view w-full sm:w-auto"
          >
            View Audit Details
          </button>
        </template>
