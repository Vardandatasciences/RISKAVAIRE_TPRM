    ...
    <div class="kpi-cards-grid">
      <div class="kpi-card">
        <div class="kpi-card-content">
          ...
          <div class="kpi-card-text">
            <h3 class="kpi-card-title">Today's Activities</h3>
            <div class="kpi-card-value">{{ formatNumber(dashboardStats.today_activities || 0) }}</div>
            <p class="kpi-card-subheading">System-wide logs</p>
          </div>
        </div>
      </div>
      ...
      <div class="kpi-card">
        <div class="kpi-card-content">
          ...
          <div class="kpi-card-text">
            <h3 class="kpi-card-title">This Week</h3>
            <div class="kpi-card-value">{{ formatNumber(dashboardStats.week_activities || 0) }}</div>
            <p class="kpi-card-subheading">System-wide logs</p>
          </div>
        </div>
      </div>
      ...
      <div class="kpi-card">
        <div class="kpi-card-content">
          ...
          <div class="kpi-card-text">
            <h3 class="kpi-card-title">Favorites</h3>
            <div class="kpi-card-value">{{ dashboardStats.favorites_count || 0 }}</div>
          </div>
        </div>
      </div>
      ...
      <div class="kpi-card">
        <div class="kpi-card-content">
          ...
          <div class="kpi-card-text">
            <h3 class="kpi-card-title">Most Active Module</h3>
            <div class="kpi-card-value">{{ dashboardStats.most_active_module || 'N/A' }}</div>
          </div>
        </div>
      </div>
    </div>
...
/* KPI Cards Grid - Override for 4 columns in Quick Access Dashboard */
.QAC_quick-access-dashboard .kpi-cards-grid {
  margin-bottom: 2rem;
}
