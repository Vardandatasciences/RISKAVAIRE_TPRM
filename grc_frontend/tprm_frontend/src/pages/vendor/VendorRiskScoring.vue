        ...
        <div class="filter-row">
          ...
          <div class="filter-dropdowns">
            ...
            <SingleSelectDropdown
              ...
              :placeholder="vendorsLoading ? 'Loading...' : `All Vendors (${vendorOptions.length - 1})`"
              height="2.5rem"
              @update:model-value="selectVendorOption"
            />
            ...
            <SingleSelectDropdown
              ...
              height="2.5rem"
              @update:model-value="selectModuleOption"
            />
            ...
            <SingleSelectDropdown
              ...
              height="2.5rem"
              @update:model-value="selectPriorityOption"
            />
            ...
            <SingleSelectDropdown
              ...
              placeholder="Date"
              height="2.5rem"
              @update:model-value="selectDateOption"
            />
          </div>
...
const toggleAiModuleSelect = () => {
 ...
 const selectVendorOption = (value) => {
   ...
   // Update the filter (v-model already handles this, but keeping for logging)
...
// Click outside handler (only for AI module dropdown)
