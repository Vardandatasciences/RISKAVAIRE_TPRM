    ...
    <div class="assignment-header">
      <div class="header-content">
        ...
        <div class="header-actions">
          <button @click="openAssignmentModal" class="button button--create">
      ...
      <div class="kpi-cards-grid">
        <div class="kpi-card">
          <div class="kpi-card-content">
            ...
            <div class="kpi-card-text">
              <h3 class="kpi-card-title">Total Assignments</h3>
              <div class="kpi-card-value">{{ Array.isArray(assignments) ? assignments.length : 0 }}</div>
            </div>
          </div>
        </div>
        ...
        <div class="kpi-card">
          <div class="kpi-card-content">
            ...
            <div class="kpi-card-text">
              <h3 class="kpi-card-title">Pending</h3>
              <div class="kpi-card-value">{{ getStatusCount('ASSIGNED') }}</div>
            </div>
          </div>
        </div>
        ...
        <div class="kpi-card">
          <div class="kpi-card-content">
            ...
            <div class="kpi-card-text">
              <h3 class="kpi-card-title">In Progress</h3>
              <div class="kpi-card-value">{{ getStatusCount('IN_PROGRESS') }}</div>
            </div>
          </div>
        </div>
        ...
        <div class="kpi-card">
          <div class="kpi-card-content">
            ...
            <div class="kpi-card-text">
              ...
              <div class="kpi-card-value">{{ getStatusCount('SUBMITTED') + getStatusCount('RESPONDED') + getStatusCount('COMPLETED') }}</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div v-if="showAssignmentModal" class="modal-overlay" @click="closeModal">
      <div class="modal-content" @click.stop>
            ...
            <div class="global-form-box">
              <div class="global-form-row">
                <div class="global-form-group">
                  <label class="global-form-label">Select Questionnaire</label>
                  <select v-model="newAssignment.questionnaire_id" class="global-form-select" required>
                ...
                <div class="global-form-group">
                  ...
                  <select v-model="newAssignment.vendor_id" class="global-form-select" required>
                ...
                <div class="global-form-group">
                  <label class="global-form-label">Due Date (Optional)</label>
                  <input 
              ...
              <div class="global-form-group">
                <label class="global-form-label">Notes (Optional)</label>
                <textarea 
        ...
        <div class="modal-footer">
          ...
          <button @click="createAssignment" class="button button--create" :disabled="!canCreateAssignment">
            Create Assignment
          </button>
        </div>
      </div>
...
const statusFilterOptions = [
  ...
  { value: 'SUBMITTED', label: 'Responded' },
  { value: 'RESPONDED', label: 'Responded' },
  { value: 'COMPLETED', label: 'Completed' },
  { value: 'OVERDUE', label: 'Overdue' }
]

const questionnaireFilterOptions = computed(() => {
  return [
    { value: '', label: 'All Questionnaires' },
    ...questionnaires.value.map(q => ({
      value: q.questionnaire_id,
      label: q.questionnaire_name
    }))
  ]
})
...
/* Search Bar Fix - Prevent Icon Collision */
.search-container {
  width: 100%;
}
...
/* Status Badge styles are now imported from badge.css */
