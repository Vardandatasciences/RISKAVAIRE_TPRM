  ...
  <div v-else class="comprehensive-workflow-creator">
    ...
    <div class="workflow-card card">
      ...
      >
        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="form-item">
              ...
              <select v-model="workflowForm.workflow_type" class="global-form-select">
        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="form-item">
              ...
              <select v-model="requestForm.priority" class="global-form-select">
        ...
        <!-- Tab Navigation Buttons -->
        <div class="tab-actions">
          <button type="button" class="button button--back" @click="activeTab = 'workflow'">
            Back to Workflow
          </button>
          ...
          <div v-if="approvalType === 'questionnaire_approval' && selectedQuestionnaire && Object.keys(selectedQuestionnaireData).length > 0">
            ...
            <div class="questionnaire-card card">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-12">
                    <div class="form-item">
                      ...
                      <input :value="selectedQuestionnaireData.questionnaire_id || '13'" class="global-form-input" readonly />
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="form-item">
                      <label class="form-label">Version</label>
                      <input :value="selectedQuestionnaireData.version || '1.0'" class="global-form-input" readonly />
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="form-item">
                      ...
                      <input :value="selectedQuestionnaireData.questionnaire_type || 'ONBOARDING'" class="global-form-input" readonly />
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="form-item">
                      <label class="form-label">Created Date</label>
                      <input :value="selectedQuestionnaireData.created_at ? formatDate(selectedQuestionnaireData.created_at) : '9/9/2025 5:19:21 AM'" class="global-form-input" readonly />
                    </div>
                  </div>
                </div>
                ...
                <div class="form-item">
                  <label class="form-label">Approval Type</label>
                  <input value="Questionnaire Approval" class="global-form-input" readonly />
                </div>
              </div>
            </div>
          </div>
                    ...
                    <div class="row" style="margin-bottom: 20px">
                      <div class="col-12">
                        <div class="form-item">
                          ...
                          <input :value="selectedAssignmentData.vendor_company_name || 'GlobalMed Supplies'" class="global-form-input" readonly />
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-item">
                          <label class="form-label">Vendor Code</label>
                          <input :value="selectedAssignmentData.vendor_code || 'V002'" class="global-form-input" readonly />
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="form-row-enhanced">
                      <div class="form-item-enhanced">
                        ...
                        <div class="select-wrapper-enhanced">
                          <select v-model="responseType" class="global-form-select">
                      ...
                      <div class="form-item-enhanced">
                        ...
                        <div class="select-wrapper-enhanced">
                          <select v-model="responsePriority" class="global-form-select">
                            <option value="">Select priority</option>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <div class="form-item">
                        <label class="form-label">Vendor Code</label>
                        <input value="VEND00968" class="global-form-input" readonly />
                      </div>
                    </div>
                    <div class="col-12">
                      <div class="form-item">
                        <label class="form-label">Legal Name</label>
                        <input value="Acme Corporation Inc. Ltd. vardaan" class="global-form-input" readonly />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="form-item">
                        ...
                        <input value="partnership" class="global-form-input" readonly />
                      </div>
                    </div>
                    <div class="col-12">
                      <div class="form-item">
                        <label class="form-label">Industry Sector</label>
                        <input value="technology" class="global-form-input" readonly />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="form-item">
                        ...
                        <input value="services" class="global-form-input" readonly />
                      </div>
                    </div>
                    <div class="col-12">
                      <div class="form-item">
                        <label class="form-label">Website</label>
                        <input value="https://acme.com" class="global-form-input" readonly />
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-8">
                        <div class="form-item">
                          ...
                          <input value="500" class="global-form-input" readonly />
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <!-- Tab Navigation Buttons -->
        <div class="tab-actions">
          <button type="button" class="button button--back" @click="activeTab = 'request'">
            Back to Request
          </button>
        ...
        <div class="stages-section">
          <div class="stages-header">
            ...
            <button type="button" class="button button--add" @click="addStage">
              Add Stage
            </button>
          </div>
          ...
          <div v-if="stages.length === 0" class="no-stages">
            <div class="empty">
              ...
              <button type="button" class="button button--add" @click="addStage">Add First Stage</button>
            </div>
          </div>
        ...
        <!-- Tab Navigation Buttons -->
        <div class="tab-actions">
          <button type="button" class="button button--back" @click="activeTab = 'data'">
            Back to Data
          </button>
        </div>
        </div>
        ...
        <div class="form-actions">
          ...
          <button type="submit" class="button button--create btn btn-primary" :disabled="submitting">
    ...
    <div v-if="successDialogVisible" class="dialog-overlay" @click="successDialogVisible = false">
      <div class="dialog" @click.stop>
        ...
        <div class="dialog-footer">
          ...
          <button class="button button--create btn btn-primary" @click="createAnother">Create Another</button>
        </div>
      </div>
    </div>
...
export default {
  ...
  setup() {
    ...
    onMounted(async () => {
      ...
      console.log('[ApprovalWorkflowCreator] Is in iframe:', isInIframe)
      
      // If in iframe mode, check for GRC user first and allow access if found
      if (isInIframe) {
        console.log('[ApprovalWorkflowCreator] In iframe mode, checking for GRC user...')
          ...
          if (userStr) {
            try {
              ...
              if (user && (user.id || user.userid || user.user_id || user.username || user.email || user.name)) {
                console.log(`[ApprovalWorkflowCreator] Found GRC user in ${key}:`, {
              ...
              console.warn(`[ApprovalWorkflowCreator] Could not parse user from ${key}:`, e)
            }
          }
        }
        ...
        if (!grcUserFound) {
          ...
          if (hasToken) {
            console.log('[ApprovalWorkflowCreator] Found token in iframe mode, allowing access (GRC handles permissions)')
            grcUserFound = true
          }
        }
        
        if (grcUserFound) {
          console.log('[ApprovalWorkflowCreator] GRC user/token found, allowing access in iframe mode (GRC handles permissions)')
          hasAccess.value = true
          await fetchUsers()
          
          const currentUser = getCurrentUser() || foundUser
          if (currentUser) {
            workflowForm.created_by = currentUser.name || currentUser.username || currentUser.email || 'Current User'
            requestForm.requester_id = currentUser.id || currentUser.userid || currentUser.user_id
            requestForm.requester_name = currentUser.name || currentUser.username || currentUser.email || 'Current User'
            requestForm.requester_department = currentUser.department || currentUser.dept || ''
          ...
          console.warn('[ApprovalWorkflowCreator] No GRC user or token found in iframe mode, will check permissions')
        }
      }
...
/* Form Inputs - Now handled by form.css */
...
/* Form select enhanced - Now using global-form-select */
...
/* Form textarea enhanced - Now using global-form-textarea */
