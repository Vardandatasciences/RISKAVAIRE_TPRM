<template>
  <div class="contract-review-container contract-review-edit-page">
    <!-- Header Section -->
    ...
    <div v-else-if="contract" class="review-content">
      ...
      <div class="contract-terms-section">
        <div class="section-header">
          ...
          <button type="button" @click="addTerm" class="button button--add">
            Add Term
          </button>
        </div>
      ...
      <div class="contract-clauses-section">
        <div class="section-header">
          ...
          <button type="button" @click="addClause" class="button button--add">
            Add Clause
          </button>
        </div>
