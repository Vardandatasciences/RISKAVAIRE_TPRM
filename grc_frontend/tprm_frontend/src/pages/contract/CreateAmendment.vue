        ...
        <div class="border rounded-lg p-6">
          <h4 class="text-lg font-medium mb-4">Amendment Details</h4>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <input v-model="amendmentForm.amendment_number" class="global-form-input" placeholder="e.g., AMEND-001" />
              </div>
            <div class="space-y-2">
              <label class="text-sm font-medium">Amendment Date *</label>
              <input v-model="amendmentForm.amendment_date" type="date" class="global-form-date-input" />
            </div>
            <div class="space-y-2">
              <label class="text-sm font-medium">Effective Date *</label>
              <input v-model="amendmentForm.effective_date" type="date" class="global-form-date-input" />
            </div>
            <div class="space-y-2">
              <label class="text-sm font-medium">Amendment Type</label>
              <select v-model="amendmentForm.amendment_type" class="global-form-select">
          ...
          <div class="space-y-2 mt-4">
            ...
            <textarea v-model="amendmentForm.amendment_reason" rows="3" class="global-form-textarea" placeholder="Describe the reason for this amendment..."></textarea>
          </div>
          <div class="space-y-2 mt-4">
            <label class="text-sm font-medium">Changes Summary *</label>
            <textarea v-model="amendmentForm.changes_summary" rows="3" class="global-form-textarea" placeholder="Summarize the key changes..."></textarea>
          </div>
        </div>
        ...
        <div class="border rounded-lg p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-2">
              ...
              <input v-model="formData.contract_title" class="global-form-input" placeholder="e.g., Cloud Infrastructure Services Agreement" />
            </div>
              <div class="space-y-2">
              <label class="text-sm font-medium">Contract Number</label>
              <input v-model="formData.contract_number" class="global-form-input" placeholder="e.g., CNT-2024-001" />
            </div>
            <div class="space-y-2">
              <label class="text-sm font-medium">Contract Type *</label>
              <select v-model="formData.contract_type" class="global-form-select">
            ...
            <div class="space-y-2">
              ...
              <select v-model="formData.priority" class="global-form-select">
            ...
            <div class="space-y-2">
              ...
              <select v-model="formData.contract_category" class="global-form-select">
        ...
        <div class="border rounded-lg p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-2">
              ...
              <select v-model="formData.vendor_id" class="global-form-select">
            ...
            <div class="space-y-2">
              ...
              <input :value="formData.vendor_name" class="global-form-input" readonly />
            </div>
          </div>
        </div>
      </TabsContent>
        ...
        <div class="border rounded-lg p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-2">
              ...
              <input v-model="amendmentForm.financial_impact" type="number" step="0.01" class="global-form-input" placeholder="0.00" />
            </div>
            <div class="space-y-2">
              <label class="text-sm font-medium">Impact Type</label>
              <select v-model="amendmentForm.impact_type" class="global-form-select">
        ...
        <div class="border rounded-lg p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-2">
              ...
              <input v-model="formData.contract_value" type="number" step="0.01" class="global-form-input" placeholder="250000" />
            </div>
            <div class="space-y-2">
              <label class="text-sm font-medium">Currency</label>
              <select v-model="formData.currency" class="global-form-select">
            ...
            <div class="space-y-2">
              ...
              <input v-model="formData.liability_cap" type="number" step="0.01" class="global-form-input" placeholder="e.g., 1000000" />
            </div>
          </div>
        </div>
      </TabsContent>
        ...
        <div class="border rounded-lg p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-2">
              ...
              <input v-model="formData.start_date" type="date" class="global-form-date-input" />
            </div>
            <div class="space-y-2">
              <label class="text-sm font-medium">End Date *</label>
              <input v-model="formData.end_date" type="date" class="global-form-date-input" />
            </div>
            <div class="space-y-2">
              <label class="text-sm font-medium">Notice Period (Days)</label>
              <input v-model="formData.notice_period_days" type="number" class="global-form-input" placeholder="30" />
            </div>
          </div>
          ...
          <div class="space-y-2 mt-4">
            ...
            <textarea v-model="formData.renewal_terms" rows="3" class="global-form-textarea" placeholder="Enter detailed renewal terms and conditions..."></textarea>
          </div>
        </div>
      </TabsContent>
        ...
        <div class="border rounded-lg p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-2">
              ...
              <select v-model="formData.contract_owner" class="global-form-select">
            ...
            <div class="space-y-2">
              ...
              <select v-model="formData.legal_reviewer" class="global-form-select">
            ...
            <div class="space-y-2">
              ...
              <select v-model="formData.assigned_to" class="global-form-select">
            ...
            <div class="space-y-2">
              ...
              <select v-model="formData.status" class="global-form-select">
        ...
        <div class="border rounded-lg p-6">
          ...
          <div class="space-y-3">
            <div class="space-y-2">
              ...
              <select v-model="formData.compliance_framework" class="global-form-input">
        ...
        <div class="border rounded-lg p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-2">
              ...
              <input v-model="formData.contract_risk_score" type="number" step="0.01" min="0" max="10" class="global-form-input" placeholder="0.00 - 10.00" />
            </div>
            <div class="space-y-2">
              <label class="text-sm font-medium">Dispute Resolution</label>
              <select v-model="formData.dispute_resolution_method" class="global-form-input">
            ...
            <div class="space-y-2">
              ...
              <input v-model="formData.governing_law" class="global-form-input" placeholder="e.g., California, USA" />
          </div>
            <div class="space-y-2">
              <label class="text-sm font-medium">Termination Clause</label>
              <select v-model="formData.termination_clause_type" class="global-form-input">
...
const handleFileUpload = async (event) => {
  ...
  try {
    ...
    // Call OCR API endpoint with authentication
    const headers = {
...
// Quickly populate the amendment form with example data for demo/testing
const loadExampleData = () => {
  // Core contract data
  formData.value = {
    ...formData.value,
    contract_title: 'Cloud Infrastructure Services Agreement - Amendment',
    ...
    currency: 'USD',
    liability_cap: '1200000',
    start_date: '2025-01-01',
    end_date: '2026-01-01',
    renewal_terms: 'Auto-renews annually with 30 days notice.',
    auto_renewal: true,
    notice_period_days: 30,
    status: 'DRAFT',
    workflow_stage: 'draft',
  ...
  amendmentForm.value = {
    ...amendmentForm.value,
    amendment_number: 'AMEND-EX-001',
    amendment_date: '2025-02-01',
    effective_date: '2025-02-15',
    amendment_type: 'terms',
    financial_impact: '25000',
    impact_type: 'increase',
    amendment_reason: 'Scope expansion to include premium support.',
    changes_summary: 'Adds premium support SLA and adjusts service levels.',
    notice_period_days: 30,
    auto_renewal: true,
    renewal_terms: 'Premium support renews annually with 30 days notice.',
  ...
  contractTerms.value = [
    reactive({
      ...
      term_text: 'Invoices payable within 30 days; late payments incur 1.5% monthly interest.',
      risk_level: 'Low',
      compliance_status: 'Pending',
      is_standard: true,
      approval_status: 'Pending',
    ...
    reactive({
      ...
      term_title: 'Premium Support SLA',
      term_text: '99.95% uptime; Sev1 response in 1 hour; Sev2 response in 4 hours.',
      risk_level: 'Medium',
      compliance_status: 'Pending',
      is_standard: false,
      approval_status: 'Pending',
  ...
  contractClauses.value = [
    reactive({
      ...
      clause_type: 'standard',
      clause_text: 'Liability capped at fees paid in the preceding 12 months.',
      risk_level: 'medium',
    ...
    reactive({
      ...
      clause_name: 'Renewal Terms',
      clause_type: 'renewal',
      clause_text: 'Agreement auto-renews annually unless 30 days notice is provided.',
      risk_level: 'low',
      legal_category: 'Contract Renewal',
      version_number: '1.0',
      is_standard: false,
      notice_period_days: 30,
      auto_renew: true,
      renewal_terms: 'Auto-renews with 3% price uplift.'
    })
  ]
  ...
  PopupService.success('Loaded example amendment data.', 'Example Loaded')
}
