            ...
            <div class="p-6 space-y-4">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="space-y-2">
                  ...
                  <select :value="formData.risk_level" @change="(e) => formData.risk_level = e.target.value" class="global-form-select">
                ...
                <div class="space-y-2">
                  ...
                  <select :value="formData.contract_category" @change="(e) => formData.contract_category = e.target.value" class="global-form-select">
            ...
            <div class="p-6 space-y-4">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="space-y-2">
                  ...
                  <select :value="formData.currency" @change="(e) => formData.currency = e.target.value" class="global-form-input">
                  ...
                  <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div class="space-y-2">
                        ...
                        <select :value="term.term_category" @change="(e) => term.term_category = e.target.value" class="global-form-input" :class="!term.term_category ? 'border-red-500' : ''">
                          <option value="">Select category</option>
                  ...
                  <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div class="space-y-2">
                        ...
                        <select :value="clause.clause_type" @change="(e) => clause.clause_type = e.target.value" class="global-form-input">
            ...
            <div class="p-6 space-y-4">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-2">
                  ...
                  <select :value="formData.dispute_resolution" @change="(e) => formData.dispute_resolution = e.target.value" class="global-form-input">
                ...
                <div class="space-y-2">
                  ...
                  <select :value="formData.termination_clause" @change="(e) => formData.termination_clause = e.target.value" class="global-form-input">
