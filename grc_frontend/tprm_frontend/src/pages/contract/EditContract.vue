  ...
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-4">
        <button type="button" class="button button--back" @click="navigate('/contracts')">
        </button>
        <div>
    ...
    <div v-else-if="error" class="text-center py-12">
      ...
      <div class="mt-6">
        ...
        <button type="button" class="button button--back ml-2" @click="navigate('/contracts')">
          Back to Contracts
        </button>
      </div>
    </div>
      ...
      <div class="space-y-8">
          ...
          <div class="border rounded-lg bg-card">
            ...
            <div class="p-6 space-y-4">
              ...
              <div v-else class="text-center py-12">
                ...
                <button type="button" class="button button--create mt-4" @click="showAmendmentForm = true">
        ...
        <div class="space-y-6">
          <div class="flex justify-between items-center">
            ...
            <button type="button" class="button button--add" @click="navigate(`/contracts/${contractId}/create-subcontract`)">
              <Plus class="w-4 h-4" />
              Add Subcontract
            </button>
          </div>
          ...
          <div class="border rounded-lg bg-card">
            <div class="p-6 text-center">
              ...
              <button type="button" class="button button--add mt-4" @click="navigate(`/contracts/${contractId}/create-subcontract`)">
          ...
          <div class="border rounded-lg bg-card">
            ...
            <div class="p-6 space-y-4">
              ...
              <div class="flex gap-2">
                <button type="button" class="button button--add" @click="showAmendTermForm = !showAmendTermForm">
                  <FileText class="w-4 h-4" />
                  Amend Term
                </button>
              </div>
            ...
            <div v-if="showAmendTermForm" class="border rounded-lg bg-card p-6 mb-6">
                ...
                <div class="space-y-4">
                  ...
                  <div v-if="selectedTermForAmendment" class="space-y-4">
                    ...
                    <div class="flex gap-2">
                      <button type="button" class="button button--create" @click="createTermAmendment">
                        <FileText class="w-4 h-4" />
                        Create Amendment
                      </button>
          ...
          <div class="border rounded-lg bg-card">
            ...
            <div class="p-6 space-y-4">
              <div class="flex justify-between items-center">
                ...
                <div class="flex gap-2">
                  <button type="button" class="button button--add" @click="showAmendClauseForm = !showAmendClauseForm">
                    <FileText class="w-4 h-4" />
                    Amend Clause
                </button>
                </div>
              ...
              <div class="space-y-4">
                  ...
                  <div v-if="selectedClauseForAmendment" class="space-y-4">
                    ...
                    <div class="flex gap-2">
                      <button type="button" class="button button--create" @click="createClauseAmendment">
                        <FileText class="w-4 h-4" />
                        Create Amendment
                      </button>
