<template>
  <div class="space-y-8 contract-detail-page">
    <!-- Header -->
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-3">
          ...
          <button type="button" class="button button--edit" @click="navigate(`/contracts/${contractId}/edit`)">
          <Edit class="w-4 h-4" />
            Edit Contract
        </button>
        </div>
    ...
    <Card v-if="daysUntilExpiry > 0 && daysUntilExpiry <= 30" class="border-amber-200 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 dark:border-amber-800">
      <CardContent class="pt-6">
        <div class="flex items-center gap-4">
          ...
          <button type="button" class="button button--start">
            Start Renewal
          </button>
        </div>
      </CardContent>
    ...
    <Tabs v-model="activeTab" class="space-y-8">
      ...
      <TabsContent value="amendments" class="space-y-6">
        <div class="flex justify-between items-center">
          ...
          <button type="button" class="button button--create" @click="navigate(`/contracts/${contractId}/create-amendment`)">
            Create Amendment
          </button>
        </div>
            ...
            <CardContent class="pt-6">
              <div class="flex justify-between items-start">
                ...
                <div class="flex flex-col gap-2 ml-4">
                  <button type="button" class="button button--view" @click="navigate(`/contracts/${amendment.contract_id}`)" title="View Amendment Details">
                    View
                  </button>
                  <button type="button" class="button button--edit" @click="navigate(`/contracts/${amendment.contract_id}/edit-advanced`)" title="Edit Amendment">
                    <Edit class="w-4 h-4" />
                  </button>
      ...
      <TabsContent value="subcontracts" class="space-y-6">
        <div class="flex justify-between items-center">
          ...
          <button type="button" class="button button--add" @click="navigate(`/contracts/${contractId}/subcontract`)">
            Add Subcontract
          </button>
        </div>
          ...
          <Card v-for="subcontract in subcontracts" :key="subcontract.contract_id" class="hover:shadow-lg transition-shadow duration-200 border-slate-200 dark:border-slate-700">
            ...
            <CardContent v-else class="pt-6">
              <div class="flex justify-between items-start">
                ...
                <!-- Actions -->
                <div class="flex flex-col gap-2 ml-4">
                  <button type="button" class="button button--view" @click="navigate(`/contracts/${subcontract.contract_id}`)" title="View Subcontract Details">
                    View
                  </button>
                  <button type="button" class="button button--edit" @click="navigate(`/contracts/${subcontract.contract_id}/edit-advanced`)" title="Edit Subcontract">
                    <Edit class="w-4 h-4" />
                  </button>
      ...
      <TabsContent value="renewals" class="space-y-6">
        <div class="flex justify-between items-center">
          ...
          <button type="button" class="button button--start gap-2">
        ...
        <div class="grid gap-4">
          ...
          <Card v-if="!contractRenewals.length">
            <CardContent class="text-center py-12">
              ...
              <button type="button" class="button button--start mt-4">Start Renewal Process</button>
            </CardContent>
          </Card>
        </div>
      </TabsContent>
