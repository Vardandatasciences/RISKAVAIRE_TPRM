      ...
      <CardContent class="p-4 lg:p-6">
        <div class="space-y-4">
          <div class="global-form-group">
            <Label for="contract-select" class="global-form-label">Select Contract</Label>
            <select 
              id="contract-select"
    ...
    <Card class="shadow-card">
      ...
      <CardContent class="p-4 lg:p-6">
        <div class="global-form-row">
          <div class="global-form-group">
            <Label for="audit-title" class="global-form-label">Audit Title <span class="global-form-label-required">*</span></Label>
            <input
              id="audit-title"
              v-model="auditTitle"
              type="text"
          ...
          <div class="global-form-group">
            <Label for="due-date" class="global-form-label">Due Date <span class="global-form-label-required">*</span></Label>
            <input
              id="due-date"
              type="date"
              :value="dueDate"
          ...
          <div class="global-form-group">
            <Label for="frequency" class="global-form-label">Frequency</Label>
            <select 
              id="frequency"
              v-model="frequency"
              class="global-form-select"
          ...
          <div class="global-form-group">
            <Label for="audit-type" class="global-form-label">Audit Type</Label>
            <select 
              id="audit-type"
              v-model="auditType"
              class="global-form-select"
          ...
          <div class="global-form-group global-form-group-full-width">
            <Label for="audit-scope" class="global-form-label">Audit Scope</Label>
            <textarea
              id="audit-scope"
              :value="auditScope"
    ...
    <Card class="shadow-card">
      ...
      <CardContent class="p-4 lg:p-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div class="global-form-group">
            <Label for="auditor-select" class="global-form-label">Auditor <span class="global-form-label-required">*</span></Label>
            <select 
              id="auditor-select"
          ...
          <div class="global-form-group">
            <Label for="reviewer-select" class="global-form-label">Reviewer <span class="global-form-label-required">*</span></Label>
            <select 
              id="reviewer-select"
