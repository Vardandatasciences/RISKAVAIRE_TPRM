  ...
  <div class="space-y-6">
    <div class="md:flex md:items-center md:justify-between">
      ...
      <div class="mt-4 flex md:mt-0 md:ml-4">
        ...
        <button type="button" class="button button--create" @click="createNewDraft">
          Create New Draft
        </button>
      </div>
    </div>
    ...
    <div v-else-if="!isLoading && drafts.length === 0" class="bg-white shadow overflow-hidden sm:rounded-md p-8 text-center">
      ...
      <div class="mt-6">
        <button type="button" class="button button--create" @click="$router.push('/phase1-creation')">
          Create New RFP
        </button>
      </div>
    </div>
        ...
        <li v-for="draft in drafts" :key="draft.id">
          <div class="px-4 py-4 flex items-center justify-between hover:bg-gray-50">
            ...
            <div class="flex items-center space-x-2">
              <button class="button button--view" @click="viewDraft(draft)">
                View
              </button>
              <Button size="sm" variant="outline" @click="editDraft(draft)">
                {{ draft.isLocal ? 'Continue' : 'Edit' }}
              </Button>
              <button class="button button--save" @click="publishDraft(draft)">
      ...
      <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
        <div class="mt-3">
          ...
          <div class="mt-6 flex justify-end space-x-3">
            ...
            <button class="button button--save" @click="publishDraft(selectedDraft)">
