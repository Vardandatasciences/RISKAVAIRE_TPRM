<template>
  <div class="rfp-url-generation-page phase-container">
    <!-- Back Button -->
    <div class="back-button-container">
      <a href="/rfp-vendor-selection" class="button button--back">
    ...
    <div class="kpi-cards-grid">
      <div class="kpi-card">
        <div class="kpi-card-content">
          ...
          <div class="kpi-card-text">
            <p class="kpi-card-title">Selected Vendors</p>
            <p class="kpi-card-value">{{ selectedVendorsCount }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="kpi-card">
        <div class="kpi-card-content">
          ...
          <div class="kpi-card-text">
            <p class="kpi-card-title">Invitations Sent</p>
            <p class="kpi-card-value">{{ sentCount }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="kpi-card">
        <div class="kpi-card-content">
          ...
          <div class="kpi-card-text">
            <p class="kpi-card-title">Acknowledged</p>
            <p class="kpi-card-value">{{ acknowledgedCount }}</p>
          </div>
        </div>
      </div>
...
/* KPI Cards Grid - Override for 4 columns */
.kpi-cards-grid {
...
/* Buttons */
.btn-primary {
  @apply inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg font-semibold text-sm bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed;
}

.btn-secondary {
  @apply inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg font-semibold text-sm bg-white border-2 border-gray-300 text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition-all shadow-sm hover:shadow-md;
}

.btn-success {
  @apply inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg font-semibold text-sm bg-white border-2 border-green-300 text-green-700 hover:bg-green-50 hover:border-green-400 transition-all shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed;
}
