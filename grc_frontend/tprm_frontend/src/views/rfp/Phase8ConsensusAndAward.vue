    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="space-y-8">
          ...
          <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div class="flex items-center gap-2">
              ...
              <div class="flex items-center gap-2">
                ...
                <button 
                  @click="refreshData"
                  class="button button--refresh ml-2"
        ...
        <div v-if="!currentRfpId" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div v-else>
            <div class="flex items-center gap-2 justify-end mb-4 text-sm">
              <button
            ...
            <div v-if="rfpViewMode === 'grid'" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div 
                v-for="rfp in availableRfps" 
                :key="rfp.rfp_id"
                @click="selectRfp(rfp.rfp_id)"
                class="group relative bg-white border rounded-xl p-5 shadow-sm cursor-pointer transition-all duration-200 hover:border-blue-300 hover:shadow-lg overflow-hidden flex flex-col"
                :class="currentRfpId === String(rfp.rfp_id) ? 'border-blue-500 shadow-md' : 'border-gray-200'"
              >
                <!-- Title -->
                <h4 class="font-semibold text-gray-900 group-hover:text-blue-700 transition-colors break-words mb-2" style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; word-wrap: break-word;">
                      {{ rfp.rfp_title }}
                    </h4>
                
                <!-- Description -->
                <p class="text-sm text-gray-600 mb-3 break-words" style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; word-wrap: break-word;">
                      {{ rfp.description ? (rfp.description.substring(0, 100) + '...') : 'No description available' }}
                    </p>
                
                <!-- Badges and Date Section -->
                <div class="mt-auto flex items-center justify-between gap-2 flex-wrap">
                  <div class="flex items-center gap-2 flex-wrap">
                    <!-- Status Badge -->
                    <span :class="getRfpStatusClass(rfp.status)" class="text-xs font-medium">
                    {{ rfp.status || 'N/A' }}
                  </span>
                    <!-- RFP Number Badge -->
                    <span class="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium bg-gray-100 text-gray-600 uppercase">
                      {{ rfp.rfp_number }}
                    </span>
                  </div>
                  <!-- Date -->
            ...
            <div v-else class="space-y-3">
              <div 
                ...
                :key="rfp.rfp_id"
                @click="selectRfp(rfp.rfp_id)"
                class="group w-full text-left bg-white border rounded-lg p-4 shadow-sm cursor-pointer transition-all duration-200 hover:border-blue-300 hover:shadow-md overflow-hidden flex flex-col"
                :class="currentRfpId === String(rfp.rfp_id) ? 'border-blue-500 shadow-md' : 'border-gray-200'"
              >
                <!-- Title -->
                <h4 class="font-semibold text-gray-900 group-hover:text-blue-700 transition-colors break-words mb-2" style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; word-wrap: break-word;">
                ...
                <!-- Description -->
                <p class="text-sm text-gray-600 mb-3 break-words" style="display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; overflow: hidden; word-wrap: break-word;">
                      {{ rfp.description ? (rfp.description.substring(0, 100) + '...') : 'No description available' }}
                    </p>
...
// Shared status badge class for RFP cards - using badge.css classes
...
<style>
/* Global styles for Phase8ConsensusAndAward.vue to preserve colors in color blindness modes */
...
html:not(.dark-theme)[data-colorblind="protanopia"] .border-blue-100,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .border-blue-100,
html:not(.dark-theme)[data-colorblind="tritanopia"] .border-blue-100 {
...
html:not(.dark-theme)[data-colorblind="protanopia"] .hover\:bg-green-700:hover,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .hover\:bg-green-700:hover,
html:not(.dark-theme)[data-colorblind="tritanopia"] .hover\:bg-green-700:hover {
...
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-yellow-500,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-yellow-500,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-yellow-500 {
...
html:not(.dark-theme)[data-colorblind="protanopia"] .text-yellow-900,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .text-yellow-900,
html:not(.dark-theme)[data-colorblind="tritanopia"] .text-yellow-900 {
...
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-red-100,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-red-100,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-red-100 {
  background-color: #fee2e2 !important; /* red-100 */
}

html:not(.dark-theme)[data-colorblind="protanopia"] .text-red-600,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .text-red-600,
html:not(.dark-theme)[data-colorblind="tritanopia"] .text-red-600 {
...
html:not(.dark-theme)[data-colorblind="protanopia"] .text-red-800,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .text-red-800,
html:not(.dark-theme)[data-colorblind="tritanopia"] .text-red-800 {
...
html:not(.dark-theme)[data-colorblind="protanopia"] .border-red-300,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .border-red-300,
html:not(.dark-theme)[data-colorblind="tritanopia"] .border-red-300 {
  border-color: #fca5a5 !important; /* red-300 */
}

/* Gray backgrounds and text */
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-gray-50,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-gray-50,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-gray-50 {
...
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-gray-300,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-gray-300,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-gray-300 {
  background-color: #d1d5db !important; /* gray-300 */
}

html:not(.dark-theme)[data-colorblind="protanopia"] .bg-gray-400,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-gray-400,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-gray-400 {
...
/* Ensure title text is visible and properly wrapped */
html:not(.dark-theme)[data-colorblind="protanopia"] h4,
html:not(.dark-theme)[data-colorblind="deuteranopia"] h4,
html:not(.dark-theme)[data-colorblind="tritanopia"] h4 {
...
/* Preserve badge colors from badge.css when color blindness is enabled */
html:not(.dark-theme)[data-colorblind="protanopia"] .badge-approved,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .badge-approved,
html:not(.dark-theme)[data-colorblind="tritanopia"] .badge-approved,
html:not(.dark-theme)[data-colorblind="protanopia"] .badge-active,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .badge-active,
html:not(.dark-theme)[data-colorblind="tritanopia"] .badge-active {
  color: #10b981 !important; /* Green color */
}

html:not(.dark-theme)[data-colorblind="protanopia"] .badge-draft,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .badge-draft,
html:not(.dark-theme)[data-colorblind="tritanopia"] .badge-draft {
  color: #6b7280 !important; /* Neutral gray color */
}

html:not(.dark-theme)[data-colorblind="protanopia"] .badge-in-review,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .badge-in-review,
html:not(.dark-theme)[data-colorblind="tritanopia"] .badge-in-review,
html:not(.dark-theme)[data-colorblind="protanopia"] .badge-pending-assignment,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .badge-pending-assignment,
html:not(.dark-theme)[data-colorblind="tritanopia"] .badge-pending-assignment {
  color: #fb923c !important; /* Light orange color */
}

html:not(.dark-theme)[data-colorblind="protanopia"] .badge-assigned,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .badge-assigned,
html:not(.dark-theme)[data-colorblind="tritanopia"] .badge-assigned {
  color: #3b82f6 !important; /* Blue color */
}

html:not(.dark-theme)[data-colorblind="protanopia"] .badge-cancelled,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .badge-cancelled,
html:not(.dark-theme)[data-colorblind="tritanopia"] .badge-cancelled {
  color: #6b7280 !important; /* Gray color */
}

html:not(.dark-theme)[data-colorblind="protanopia"] .badge-submitted,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .badge-submitted,
html:not(.dark-theme)[data-colorblind="tritanopia"] .badge-submitted {
  color: #f59e0b !important; /* Orange/amber color */
}

html:not(.dark-theme)[data-colorblind="protanopia"] .badge-rejected,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .badge-rejected,
html:not(.dark-theme)[data-colorblind="tritanopia"] .badge-rejected {
  color: #ef4444 !important; /* Red color */
}

html:not(.dark-theme)[data-colorblind="protanopia"] .badge-completed,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .badge-completed,
html:not(.dark-theme)[data-colorblind="tritanopia"] .badge-completed {
  color: #10b981 !important; /* Green color */
}

/* Preserve RFP number badge grey background */
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-gray-100,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-gray-100,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-gray-100 {
  background-color: #f3f4f6 !important; /* gray-100 */
