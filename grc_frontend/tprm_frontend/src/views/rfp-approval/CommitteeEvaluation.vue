  ...
  <div class="min-h-screen">
    ...
    <!-- Header -->
        ...
        <div class="rounded-lg shadow-sm border border-gray-200">
          ...
          <div v-if="activeTab === 'ranking'" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div class="rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            ...
            <div class="space-y-3">
              <div 
                ...
                :class="{
                  'border-blue-300': isBeingDragged === proposal.response_id,
                  'border-green-300': proposal.ranking_position === 1
                }"
                draggable="true"
                ...
                <div class="flex items-center justify-between">
                  ...
                  <div class="flex items-center space-x-2">
                    <button 
                          ...
                          class="inline-flex items-center px-3 py-1 text-sm font-medium text-purple-600 border border-purple-200 rounded-md hover:border-purple-300"
                    >
                    ...
                    <button 
                      ...
                      class="inline-flex items-center px-3 py-1 text-sm font-medium text-blue-600 border border-blue-200 rounded-md hover:border-blue-300"
                    >
                          <span class="mr-1">📋</span>
                          Evaluate
                        </button>
                    ...
                    <div v-if="proposal.previous_evaluations && proposal.previous_evaluations.length > 0" class="mt-3 pt-3 border-t border-gray-200">
                      ...
                      <div class="space-y-1">
                        <div v-for="evaluation in proposal.previous_evaluations.slice(0, 2)" :key="evaluation.evaluator_id" class="text-xs p-2 rounded border border-gray-200">
                ...
                <div v-if="comparisonData" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div class="border border-gray-200 rounded-lg p-4">
                    ...
                    <div v-if="comparisonData.proposalA.previous_evaluations" class="mt-4 pt-4 border-t border-gray-200">
                      ...
                      <div class="space-y-2">
                        <div v-for="evaluation in comparisonData.proposalA.previous_evaluations" :key="evaluation.evaluator_id" class="text-xs p-2 rounded border border-gray-200">
                  ...
                  <div class="border border-gray-200 rounded-lg p-4">
                    ...
                    <div v-if="comparisonData.proposalB.previous_evaluations" class="mt-4 pt-4 border-t border-gray-200">
                      <h6 class="text-sm font-medium text-gray-700 mb-2">📝 Previous Evaluator Comments</h6>
                      <div class="space-y-2">
                        <div v-for="evaluation in comparisonData.proposalB.previous_evaluations" :key="evaluation.evaluator_id" class="text-xs p-2 rounded border border-gray-200">
                          <div class="font-medium text-gray-700">{{ evaluation.evaluator_name }}</div>
                          <div class="text-gray-600">{{ evaluation.comments || 'No comments' }}</div>
                        </div>
                      </div>
        ...
        <div class="rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <!-- Consensus Summary -->
          <div class="rounded-lg p-4 mb-6 border border-gray-200">
          ...
          <div class="space-y-4">
            ...
            <div v-for="member in committeeMembers" :key="member.member_id" class="rounded-lg p-3 border border-gray-200">
              ...
              <div v-if="member.evaluation_completed" class="space-y-2">
                <div 
                  ...
                  class="flex items-center justify-between text-sm p-2 rounded border border-gray-100"
                >
          ...
          <div v-if="consensusRanking.length > 0" class="consensus-ranking-section mt-6 border border-yellow-200 rounded-lg p-4">
            ...
            <div class="space-y-2">
              <div 
                ...
                :class="index === 0 ? 'border border-yellow-300' : ''"
              >
                <div class="flex items-center space-x-3">
                  <span 
                    class="inline-flex items-center justify-center w-8 h-8 rounded-full text-sm font-bold"
          ...
          <div v-else-if="shortlistedProposals.length > 0" class="mt-6 border border-gray-200 rounded-lg p-4">
    ...
    <div v-if="showProposalModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div class="rounded-lg p-6 max-w-4xl w-full mx-4 max-h-[80vh] overflow-y-auto border border-gray-200">
        <div class="flex items-center justify-between mb-4">
...
<style>
/* ============================================
   COLOR BLINDNESS OVERRIDES FOR COMMITTEE EVALUATION
   Preserve original colors when color blindness is enabled
   ============================================ */

/* Preserve purple gradient background */
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-gradient-to-r.from-purple-50.to-indigo-50,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-gradient-to-r.from-purple-50.to-indigo-50,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-gradient-to-r.from-purple-50.to-indigo-50 {
  background: linear-gradient(to right, #faf5ff 0%, #eef2ff 100%) !important;
  background-image: linear-gradient(to right, #faf5ff 0%, #eef2ff 100%) !important;
}

/* Preserve purple badges and text */
...
html:not(.dark-theme)[data-colorblind="protanopia"] .text-purple-800,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .text-purple-800,
html:not(.dark-theme)[data-colorblind="tritanopia"] .text-purple-800 {
...
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-purple-600:hover,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-purple-600:hover,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-purple-600:hover,
html:not(.dark-theme)[data-colorblind="protanopia"] .hover\:bg-purple-700:hover,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .hover\:bg-purple-700:hover,
html:not(.dark-theme)[data-colorblind="tritanopia"] .hover\:bg-purple-700:hover {
...
html:not(.dark-theme)[data-colorblind="protanopia"] .hover\:bg-purple-100:hover,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .hover\:bg-purple-100:hover,
html:not(.dark-theme)[data-colorblind="tritanopia"] .hover\:bg-purple-100:hover {
  background-color: #f3e8ff !important;
}

/* Preserve blue badges, borders, and text */
...
html:not(.dark-theme)[data-colorblind="protanopia"] .hover\:bg-blue-100:hover,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .hover\:bg-blue-100:hover,
html:not(.dark-theme)[data-colorblind="tritanopia"] .hover\:bg-blue-100:hover {
  background-color: #dbeafe !important;
}

/* Preserve green badges and text */
...
/* Preserve yellow badges and text */
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-yellow-50,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-yellow-50,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-yellow-50 {
  background-color: #fefce8 !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .text-yellow-600,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .text-yellow-600,
html:not(.dark-theme)[data-colorblind="tritanopia"] .text-yellow-600 {
...
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-yellow-200,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-yellow-200,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-yellow-200 {
  background-color: #fef08a !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .border-yellow-300,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .border-yellow-300,
html:not(.dark-theme)[data-colorblind="tritanopia"] .border-yellow-300 {
  border-color: #fde047 !important;
}

/* Preserve green gradient button */
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-gradient-to-r.from-green-600.to-emerald-600,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-gradient-to-r.from-green-600.to-emerald-600,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-gradient-to-r.from-green-600.to-emerald-600 {
  background: linear-gradient(to right, #16a34a 0%, #10b981 100%) !important;
  background-image: linear-gradient(to right, #16a34a 0%, #10b981 100%) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .bg-gradient-to-r.from-green-600.to-emerald-600:hover,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-gradient-to-r.from-green-600.to-emerald-600:hover,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-gradient-to-r.from-green-600.to-emerald-600:hover,
html:not(.dark-theme)[data-colorblind="protanopia"] .hover\:from-green-700:hover,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .hover\:from-green-700:hover,
html:not(.dark-theme)[data-colorblind="tritanopia"] .hover\:from-green-700:hover,
html:not(.dark-theme)[data-colorblind="protanopia"] .hover\:to-emerald-700:hover,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .hover\:to-emerald-700:hover,
html:not(.dark-theme)[data-colorblind="tritanopia"] .hover\:to-emerald-700:hover {
  background: linear-gradient(to right, #15803d 0%, #059669 100%) !important;
  background-image: linear-gradient(to right, #15803d 0%, #059669 100%) !important;
}

/* Preserve white text on colored buttons */
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-purple-600.text-white,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-purple-600.text-white,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-purple-600.text-white,
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-gradient-to-r.from-green-600.to-emerald-600.text-white,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-gradient-to-r.from-green-600.to-emerald-600.text-white,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-gradient-to-r.from-green-600.to-emerald-600.text-white {
  color: #ffffff !important;
}

/* Preserve icon colors */
html:not(.dark-theme)[data-colorblind="protanopia"] .text-blue-600 svg,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .text-blue-600 svg,
html:not(.dark-theme)[data-colorblind="tritanopia"] .text-blue-600 svg {
  color: #2563eb !important;
  stroke: #2563eb !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .text-green-600 svg,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .text-green-600 svg,
html:not(.dark-theme)[data-colorblind="tritanopia"] .text-green-600 svg {
  color: #16a34a !important;
  stroke: #16a34a !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .text-yellow-600 svg,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .text-yellow-600 svg,
html:not(.dark-theme)[data-colorblind="tritanopia"] .text-yellow-600 svg {
  color: #ca8a04 !important;
  stroke: #ca8a04 !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .text-purple-600 svg,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .text-purple-600 svg,
html:not(.dark-theme)[data-colorblind="tritanopia"] .text-purple-600 svg {
  color: #9333ea !important;
  stroke: #9333ea !important;
}

/* Preserve Final Consensus Ranking section - yellow to orange gradient */
html:not(.dark-theme)[data-colorblind="protanopia"] .consensus-ranking-section,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .consensus-ranking-section,
html:not(.dark-theme)[data-colorblind="tritanopia"] .consensus-ranking-section,
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-gradient-to-r.from-yellow-50.to-orange-50,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-gradient-to-r.from-yellow-50.to-orange-50,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-gradient-to-r.from-yellow-50.to-orange-50 {
  background: linear-gradient(to right, #fefce8 0%, #fff7ed 100%) !important;
  background-image: linear-gradient(to right, #fefce8 0%, #fff7ed 100%) !important;
}

/* Preserve consensus ranking section text colors */
html:not(.dark-theme)[data-colorblind="protanopia"] .consensus-ranking-section .text-gray-900,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .consensus-ranking-section .text-gray-900,
html:not(.dark-theme)[data-colorblind="tritanopia"] .consensus-ranking-section .text-gray-900 {
  color: #111827 !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .consensus-ranking-section .text-gray-600,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .consensus-ranking-section .text-gray-600,
html:not(.dark-theme)[data-colorblind="tritanopia"] .consensus-ranking-section .text-gray-600 {
  color: #4b5563 !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .consensus-ranking-section .text-gray-500,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .consensus-ranking-section .text-gray-500,
html:not(.dark-theme)[data-colorblind="tritanopia"] .consensus-ranking-section .text-gray-500 {
  color: #6b7280 !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .consensus-ranking-section .text-green-600,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .consensus-ranking-section .text-green-600,
html:not(.dark-theme)[data-colorblind="tritanopia"] .consensus-ranking-section .text-green-600 {
  color: #16a34a !important;
}

/* Preserve yellow backgrounds and borders in consensus ranking */
html:not(.dark-theme)[data-colorblind="protanopia"] .consensus-ranking-section .bg-yellow-100,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .consensus-ranking-section .bg-yellow-100,
html:not(.dark-theme)[data-colorblind="tritanopia"] .consensus-ranking-section .bg-yellow-100 {
  background-color: #fef9c3 !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .consensus-ranking-section .bg-yellow-200,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .consensus-ranking-section .bg-yellow-200,
html:not(.dark-theme)[data-colorblind="tritanopia"] .consensus-ranking-section .bg-yellow-200 {
  background-color: #fef08a !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .consensus-ranking-section .border-yellow-300,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .consensus-ranking-section .border-yellow-300,
html:not(.dark-theme)[data-colorblind="tritanopia"] .consensus-ranking-section .border-yellow-300 {
  border-color: #fde047 !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .consensus-ranking-section .border-yellow-200,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .consensus-ranking-section .border-yellow-200,
html:not(.dark-theme)[data-colorblind="tritanopia"] .consensus-ranking-section .border-yellow-200 {
  border-color: #fef08a !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .consensus-ranking-section .text-yellow-800,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .consensus-ranking-section .text-yellow-800,
html:not(.dark-theme)[data-colorblind="tritanopia"] .consensus-ranking-section .text-yellow-800 {
  color: #854d0e !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .consensus-ranking-section .bg-white,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .consensus-ranking-section .bg-white,
html:not(.dark-theme)[data-colorblind="tritanopia"] .consensus-ranking-section .bg-white {
  background-color: #ffffff !important;
}

/* Preserve orange-50 background color */
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-orange-50,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-orange-50,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-orange-50 {
  background-color: #fff7ed !important;
}

/* Preserve border-yellow-200 */
