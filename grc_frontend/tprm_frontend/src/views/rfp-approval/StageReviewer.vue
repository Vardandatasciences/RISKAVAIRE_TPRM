    ...
    <div v-if="selectedUserId && assignedStages.length > 0" class="space-y-6">
      ...
      <div class="space-y-4">
        <div 
            ...
            :key="stage.stage_id" 
          class="rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow"
        >
          <!-- Stage Header -->
          <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
          ...
          <div class="px-6 py-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
             ...
             <div class="mt-6">
               ...
               <div v-if="hasRequestData(stage)" class="border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                 <div class="p-6">
                   <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                     <div 
                       ...
                       class="group"
                     >
                       <div class="rounded-lg p-4 border border-gray-100 hover:border-gray-200 transition-all duration-200">
                           ...
                           <div class="flex-1 min-w-0">
                             ...
                             <div class="text-gray-700">
                               ...
                               <div v-if="key && String(key).toLowerCase() === 'criteria' && Array.isArray(value)" class="space-y-3">
                                 <div v-for="(criterion, index) in value" :key="index" class="rounded-lg p-4 border border-gray-100">
                                   <div class="flex items-start space-x-3">
            ...
            <div class="mt-6">
              ...
              <!-- RFP Details Content -->
              <div v-if="hasRfpDetails(stage)" class="border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                <div class="p-6">
                  <div v-if="getRfpDetailsForStage(stage)" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      <div class="space-y-4">
                        <div class="rounded-lg p-4 border border-blue-100">
                          ...
                          <div class="space-y-2 text-sm">
                            ...
                            <p><strong class="text-gray-700">Status:</strong> 
                              <span :class="getStatusBadgeClass(getRfpDetailsForStage(stage).status)">
                        ...
                        <div class="rounded-lg p-4 border border-green-100">
                      ...
                      <div class="space-y-4">
                        <div class="rounded-lg p-4 border border-purple-100">
                        ...
                        <div class="rounded-lg p-4 border border-amber-100">
                    ...
                    <!-- Description -->
                    <div v-if="getRfpDetailsForStage(stage).description" class="rounded-lg p-4 border border-gray-200">
                    ...
                    <div v-if="getRfpDetailsForStage(stage).evaluation_criteria && getRfpDetailsForStage(stage).evaluation_criteria.length > 0" class="bg-indigo-50 rounded-lg p-4 border border-indigo-100">
                      ...
                      <div class="space-y-3">
                        <div v-for="(criterion, index) in getRfpDetailsForStage(stage).evaluation_criteria" :key="index" class="rounded-lg p-3 border border-indigo-100">
                    ...
                    <!-- Attached Documents -->
                    <div v-if="getRfpDetailsForStage(stage).documents && getRfpDetailsForStage(stage).documents.length > 0" class="rounded-lg p-4 border border-red-100">
                      ...
                      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        <div
                          ...
                          class="rounded-lg p-3 border border-red-200 hover:border-red-400 hover:shadow-md transition-all duration-200 group cursor-pointer"
                        >
                          <div class="flex items-center space-x-3">
                    ...
                    <!-- Custom Fields -->
                    <div v-if="getRfpDetailsForStage(stage).custom_fields && typeof getRfpDetailsForStage(stage).custom_fields === 'object' && !Array.isArray(getRfpDetailsForStage(stage).custom_fields) && Object.keys(getRfpDetailsForStage(stage).custom_fields).length > 0" class="rounded-lg p-4 border border-yellow-100">
                      <h5 class="text-sm font-semibold text-yellow-900 mb-3">Additional Information</h5>
                      <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div v-for="(value, key) in getRfpDetailsForStage(stage).custom_fields" :key="String(key)" class="rounded-lg p-3 border border-yellow-100">
                          <p class="text-xs font-medium text-gray-500 uppercase">{{ formatKey(key) }}</p>
                          <p class="text-sm text-gray-900 mt-1">{{ formatValue(value) }}</p>
                        </div>
                      </div>
              ...
              <div v-else class="rounded-lg p-8 text-center border border-gray-200">
                <div class="text-gray-400 mb-4">
            ...
            <div v-if="isProposalEvaluation(stage)" class="mt-6 p-4 rounded-xl border border-purple-200 shadow-sm">
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
              ...
              <!-- Stage Actions -->
            <div v-if="canMakeDecision(stage)" class="mt-6 p-6 rounded-xl border border-gray-200 shadow-sm">
              ...
              <div class="space-y-6">
                ...
                <div v-if="stageDecision.decision === 'REQUEST_CHANGES'">
                  ...
                  <div v-if="stageDecision.decision === 'REQUEST_CHANGES' && stageDecision.change_request" class="mt-4 p-4 rounded-lg border border-amber-200">
                  <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                ...
                <button 
                  ...
                  class="button button--submit w-full sm:w-auto"
                >
            ...
            <div v-else-if="(stage.workflow_type === 'MULTI_LEVEL' || stage.workflow_type === 'SEQUENTIAL') && !arePreviousStagesApproved(stage) && (stage.stage_status === 'PENDING' || stage.stage_status === 'IN_PROGRESS')" class="mt-6 p-6 rounded-xl border border-yellow-200 shadow-sm">
              ...
              <div class="space-y-4">
                ...
                <div class="rounded-lg p-3 border border-yellow-200">
                  <div class="flex items-center space-x-2">
                    <svg class="w-4 h-4 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
            ...
            <div v-else-if="hasUserMadeDecision(stage)" class="mt-6 p-4 rounded-lg border border-blue-200">
              ...
              <div class="border border-blue-300 rounded-md p-4 mb-4">
              ...
              <div class="rounded-md p-4 border border-blue-200">
              ...
              <!-- Stage History -->
            <div v-if="stage.stage_status !== 'PENDING'" class="mt-6 p-4 rounded-lg border border-gray-200">
              ...
              <!-- Version Management -->
            <div class="mt-6 p-4 rounded-lg border border-blue-200">
              <div class="flex items-center justify-between mb-4">
                <div class="flex items-center space-x-2">
              ...
              <div v-if="getVersionHistoryForStage(stage)" class="space-y-3">
                <div 
                  ...
                  class="rounded-lg p-4 border border-blue-100 hover:border-blue-200 transition-colors"
                >
                  <div class="flex items-start justify-between mb-2">
                    <div class="flex items-center space-x-3">
                      <div class="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center">
    ...
    if (!responseId) {
      ...
      console.log('Approval ID:', stage.approval_id)
       ...
       try {
         ...
         const response = await fetch(`http://localhost:8000/api/rfp-approval/get-proposal-id/${stage.approval_id}/`, {
           method: 'GET',
