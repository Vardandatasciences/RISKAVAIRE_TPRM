    ...
    <div class="bg-white border-b border-gray-200 px-6 py-4">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
          <button @click="navigateBack" type="button" class="button button--back">
            Back to Approvals
          </button>
        </div>
      </div>
            ...
            <div class="pt-4 border-t border-gray-200">
              ...
              <div class="space-y-2">
                ...
                <button 
                  ...
                  class="button button--submit w-full"
                >
...
const loadRisks = async () => {
  try {
    ...
    // Build URL: http://localhost:8000/api/rfp-approval/risks-for-response/<response_id>/
  ...
  try {
    ...
    if (stageId) {
      try {
        ...
        const stageUpdateResponse = await fetch('http://localhost:8000/api/rfp-approval/update-stage-status/', {
          method: 'POST',
          headers: {
            ...getAuthHeaders(),
            'Content-Type': 'application/json',
...
<style>
/* Global styles for ProposalEvaluation.vue to preserve colors in color blindness modes */

/* Blue gradients and backgrounds */
...
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-gradient-to-r.from-blue-50.to-indigo-50 {
  background: linear-gradient(to right, #eff6ff 0%, #eef2ff 100%) !important;
  background-image: linear-gradient(to right, #eff6ff 0%, #eef2ff 100%) !important;
}
...
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-gradient-to-r.from-blue-600.to-indigo-600:hover,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-gradient-to-r.from-blue-600.to-indigo-600:hover,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-gradient-to-r.from-blue-600.to-indigo-600:hover,
...
/* Green gradients and backgrounds */
...
/* Purple gradients and backgrounds */
...
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-gradient-to-r.from-orange-50.to-amber-50,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-gradient-to-r.from-orange-50.to-amber-50,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-gradient-to-r.from-orange-50.to-amber-50 {
  background: linear-gradient(to right, #fff7ed 0%, #fffbeb 100%) !important;
  background-image: linear-gradient(to right, #fff7ed 0%, #fffbeb 100%) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .border-orange-200,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .border-orange-200,
html:not(.dark-theme)[data-colorblind="tritanopia"] .border-orange-200 {
...
/* Cyan gradients and backgrounds */
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-gradient-to-r.from-cyan-50.to-teal-50,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-gradient-to-r.from-cyan-50.to-teal-50,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-gradient-to-r.from-cyan-50.to-teal-50 {
  background: linear-gradient(to right, #ecfeff 0%, #f0fdfa 100%) !important;
  background-image: linear-gradient(to right, #ecfeff 0%, #f0fdfa 100%) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .border-cyan-200,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .border-cyan-200,
html:not(.dark-theme)[data-colorblind="tritanopia"] .border-cyan-200 {
  border-color: #a5f3fc !important;
}

/* Red gradients and backgrounds */
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-gradient-to-r.from-red-50.to-rose-50,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-gradient-to-r.from-red-50.to-rose-50,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-gradient-to-r.from-red-50.to-rose-50 {
  background: linear-gradient(to right, #fef2f2 0%, #fff1f2 100%) !important;
  background-image: linear-gradient(to right, #fef2f2 0%, #fff1f2 100%) !important;
}
...
html:not(.dark-theme)[data-colorblind="protanopia"] .bg-gradient-to-r.from-indigo-50.to-purple-50,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .bg-gradient-to-r.from-indigo-50.to-purple-50,
html:not(.dark-theme)[data-colorblind="tritanopia"] .bg-gradient-to-r.from-indigo-50.to-purple-50 {
  background: linear-gradient(to right, #eef2ff 0%, #faf5ff 100%) !important;
  background-image: linear-gradient(to right, #eef2ff 0%, #faf5ff 100%) !important;
}

html:not(.dark-theme)[data-colorblind="protanopia"] .border-indigo-200,
html:not(.dark-theme)[data-colorblind="deuteranopia"] .border-indigo-200,
html:not(.dark-theme)[data-colorblind="tritanopia"] .border-indigo-200 {
