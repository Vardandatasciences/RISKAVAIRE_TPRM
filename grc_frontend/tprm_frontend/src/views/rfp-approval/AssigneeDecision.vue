  ...
  <div class="space-y-6">
    ...
    <div v-if="approvalId && approvalRequest" class="bg-white p-6 rounded-lg border border-gray-200">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div class="space-y-3">
          <div>
            ...
            <p class="text-sm text-gray-900 font-medium break-words word-wrap">{{ approvalRequest.request_title || 'No title' }}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <span :class="getPriorityBadgeClass(approvalRequest.priority)">
        ...
        <div class="space-y-3">
          <div>
            ...
            <p class="text-sm text-gray-900 break-words word-wrap">{{ approvalRequest.workflow_name || 'Default Workflow' }}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <span :class="getStatusBadgeClass(approvalRequest.overall_status)">
      ...
      <div class="mb-6">
        ...
        <p class="text-sm text-gray-900 bg-gray-50 p-3 rounded-md mt-1 break-words word-wrap">
        ...
        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          ...
          <div v-if="pendingStagesCount > 0" class="space-y-2">
            ...
            >
              ...
              <span :class="getStatusBadgeClass(stage.stage_status)">
                {{ stage.stage_status }}
              </span>
            </div>
          </div>
...
const getStatusBadgeClass = (status: string) => {
  ...
  return statusMap[statusUpper] || 'badge-draft'
}
...
const getPriorityBadgeClass = (priority: string) => {
  ...
  return priorityMap[priorityUpper] || 'badge-priority-medium'
}
...
/* Ensure request title and description don't overflow */
.space-y-3 p,
.space-y-3 span {
  max-width: 100%;
  overflow-wrap: break-word;
