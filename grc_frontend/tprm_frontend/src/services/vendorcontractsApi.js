...
const vendorcontractsApi = {
  ...
  async getVendors(params = {}) {
    try {
      const response = await api.get('/tprm/v1/contracts/vendorcontracts/', { params })
  ...
  async getVendor(vendorId) {
    try {
      const response = await api.get(`/tprm/v1/contracts/vendorcontracts/${vendorId}/`)
      return {
        success: true,
        data: response.data.data
      }
  ...
  async getVendorStats() {
    try {
      const response = await api.get('/tprm/v1/contracts/vendorcontracts/stats/')
  ...
  async getVendorContacts(vendorId, params = {}) {
    try {
      const response = await api.get(`/tprm/v1/contracts/vendorcontracts/${vendorId}/contacts/`, { params })
      return {
        success: true,
        data: response.data.data
      }
  ...
  async createVendorContact(vendorId, contactData) {
    try {
      const response = await api.post(`/tprm/v1/contracts/vendorcontracts/${vendorId}/contacts/create/`, contactData)
      return {
        success: true,
        data: response.data.data,
  ...
  async searchVendors(searchParams) {
    try {
      const response = await api.get('/tprm/v1/contracts/vendorcontracts/', { params: searchParams })
      return {
        success: true,
        data: response.data.data,
        pagination: response.data.pagination
  ...
  async getContractComprehensiveDetail(contractId) {
    try {
      const response = await api.get(`/tprm/v1/contracts/contracts/${contractId}/comprehensive/`)
      return {
        success: true,
        data: response.data.data
      }
  ...
  async getContractApprovals(contractId) {
    try {
      const response = await api.get(`/tprm/v1/contracts/approvals/get-contract-approvals/`, {
  ...
  async updateContractApproval(approvalId, data) {
    try {
      const response = await api.put(`/tprm/v1/contracts/approvals/approvals/${approvalId}/update/`, data)
      return {
        success: true,
        data: response.data.data
      }
  ...
  async createContractApproval(data) {
    try {
      const response = await api.post(`/tprm/v1/contracts/approvals/approvals/create/`, data)
      return {
        success: true,
        data: response.data.data
      }
