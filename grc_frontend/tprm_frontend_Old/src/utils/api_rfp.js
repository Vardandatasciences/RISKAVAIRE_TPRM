...
// API_BASE_URL already includes /api/tprm, so we don't need to add /api/v1
// The backend routes are at /api/tprm/vendor-approval/ not /api/tprm/api/v1/vendor-approval/
const api = axios.create({
  baseURL: API_BASE_URL, // Use API_BASE_URL directly (already includes /api/tprm)
  timeout: 30000,
  headers: {
