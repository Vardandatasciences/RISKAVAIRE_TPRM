  ...
  setup() {
    ...
    const submitWorkflow = async () => {
      try {
        ...
        const response = await api.post('/vendor-approval/create-workflow-request/', submitData)
    ...
    const fetchQuestionnaires = async () => {
      try {
        ...
        const response = await api.get('/vendor-approval/questionnaires/active/')
    ...
    const fetchVendors = async () => {
      try {
        ...
        const response = await api.get('/vendor-approval/vendors/')
    ...
    const handleVendorChange = async (event) => {
      ...
      try {
        ...
        const [vendorResponse, risksResponse] = await Promise.all([
          api.get(`/vendor-approval/vendors/${vendorId}/`),
          api.get(`/vendor-approval/vendors/${vendorId}/risks/`)
        ])
    ...
    const fetchQuestionnaireAssignments = async () => {
      try {
        ...
        const response = await api.get('/vendor-approval/questionnaire-assignments/submitted/')
