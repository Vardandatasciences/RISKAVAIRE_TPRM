...
MIDDLEWARE = [
    ...
    # MULTI-TENANCY: TPRM tenant context middleware (using GRC middleware for now)
    # Note: tprm_backend.core.tenant_middleware doesn't exist, using GRC middleware instead
