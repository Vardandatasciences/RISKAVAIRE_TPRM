...
class RiskAnalysisService:
    ...
    See INTEGRATION_GUIDE.md for complete examples and integration patterns!
    """
    ...
    def analyze_comprehensive_plan_data(self, entity: str, comprehensive_data: Dict) -> Dict:
        """
        Analyze comprehensive entity data including main info, related details, and additional data
        
        Args:
            entity: logical module name (e.g., contract_module)
            comprehensive_data: Complete entity data structure
        ...
        try:
            ...
            if not comprehensive_data or 'contract_info' not in comprehensive_data:
                raise ValueError("comprehensive_data must contain contract_info")
            
            contract_info = comprehensive_data.get('contract_info', {})
            terms = comprehensive_data.get('terms', [])
            clauses = comprehensive_data.get('clauses', [])
            ...
            created_risks = comprehensive_llama_service.create_risks_from_comprehensive_data(
                entity=entity,
                plan_info=contract_info,
                extracted_details={'terms': terms, 'clauses': clauses},
            ...
            logger.info(f"Generated {len(risks_response)} risks for comprehensive {entity} contract {contract_id}")
            ...
            logger.error(f"Error analyzing comprehensive entity data for {entity}: {str(e)}")
            raise
