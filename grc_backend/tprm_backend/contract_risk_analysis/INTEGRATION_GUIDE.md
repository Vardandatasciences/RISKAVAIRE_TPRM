...
Edit `backend/contract_risk_analysis/entity_service.py` and add your module's tables:
...
In `backend/contract_risk_analysis/entity_service.py`, add methods to fetch your module's data:
...
```python
# In contract_risk_analysis/entity_service.py (lines 111-167)
