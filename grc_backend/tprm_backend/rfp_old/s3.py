...
class RenderS3Client:
    ...
    def test_connection(self) -> Dict:
        ...
        try:
            ...
            if self.db_pool:
                ...
                print("[WARN] MySQL database: Not configured")
    ...
    def download(self, s3_key: str, file_name: str, 
        ...
        try:
            print(f"[DOWNLOAD] Downloading {file_name} via Direct...")
    ...
    def export(self, data: Union[List[Dict], Dict], export_format: str, 
        ...
        try:
            ...
            print(f"[EXPORT] Exporting {record_count} records as {export_format.upper()} via Direct...")
            ...
            print(f"[ERROR] Full error details: {type(e).__name__}: {error_msg}")
...
def test_all_export_formats():
    ...
    for i, export_format in enumerate(export_formats, 1):
        ...
        try:
            ...
            if export_result['success']:
                ...
                print(f"   [EMOJI] Size: {export_result['export_info']['size']} bytes")
                ...
                try:
                    ...
                    if download_response.status_code == 200:
                        ...
                        print(f"   [EMOJI] Saved locally: {local_filename}")
                    else:
    ...
    if history:
        for i, op in enumerate(history, 1):
            status_emoji = "SUCCESS:" if op['status'] == 'completed' else "ERROR:" if op['status'] == 'failed' else "⏳"
