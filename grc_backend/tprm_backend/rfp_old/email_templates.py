    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 25px; border-radius: 10px; margin: 25px 0; text-align: center;">
                <h2 style="margin: 0 0 15px 0; color: white; font-size: 24px;">[EMOJI] Quick Access to Vendor Portal</h2>
            ...
            <div class="section">
                <h2><span class="emoji">[EMOJI]</span>Why You Were Selected</h2>
                <ul>
            ...
            <div class="section">
                <h2><span class="emoji">[EMOJI]</span>RFP Information</h2>
                <div class="info-grid">
                    <div class="info-item">
            ...
            {f'<div class="section"><h2><span class="emoji">[EMOJI]</span>Additional Message</h2><p>{custom_message}</p></div>' if custom_message else ''}
            
            <div class="section">
                <h2><span class="emoji">[EMOJI]</span>RFP Process Overview</h2>
                <div class="timeline">
            ...
            <div class="section">
                <h2><span class="emoji">[EMOJI]</span>Your Unique Invitation Link</h2>
            ...
            <div class="section">
                <h2><span class="emoji">[EMOJI]</span>Response Required</h2>
                ...
                <div class="cta-buttons">
                    <a href="{acknowledgment_url}" class="btn btn-success">[EMOJI] Acknowledged</a>
                    <a href="{decline_url}" class="btn btn-danger">[EMOJI] Unsubscribe</a>
                </div>
            ...
            <div class="section">
                <h2><span class="emoji">[EMOJI]</span>What Happens Next?</h2>
                <div class="info-grid">
                    <div class="info-item">
                        <h3>If You Accept:</h3>
                        <ul>
            ...
            <div class="section">
                <h2><span class="emoji">[EMOJI]</span>Support & Contact Information</h2>
                <div class="info-grid">
                    <div class="info-item">
                        <h3>[EMOJI] Technical Support</h3>
            ...
            <div class="security-notice">
                <h3><span class="emoji">[EMOJI]</span>Security & Confidentiality</h3>
        ...
        <div class="footer">
            ...
            <p>
                <span class="emoji">[EMOJI]</span> Email: rfp@company.com | 
                <span class="emoji">[EMOJI]</span> Website: www.company.com | 
                <span class="emoji">[EMOJI]</span> Portal: {external_base_url}
            </p>
