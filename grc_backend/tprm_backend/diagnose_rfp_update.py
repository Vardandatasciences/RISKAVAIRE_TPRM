...
try:
    ...
    print(f"[EMOJI] Found RFP 128: {rfp.rfp_title}")
except Exception as e:
    print(f"[EMOJI] Error getting RFP: {e}")
    traceback.print_exc()
    exit(1)
...
try:
    ...
    print("[EMOJI] Serializer created")
except Exception as e:
    print(f"[EMOJI] Error creating serializer: {e}")
    traceback.print_exc()
    exit(1)
...
try:
    ...
    print(f"[EMOJI] Error during validation: {e}")
    traceback.print_exc()
    exit(1)
