...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            ...
            self.stdout.write(self.style.SUCCESS(f'[EMOJI] Policy: {updated} records processed'))
            ...
            total_updated += updated
            self.stdout.write(self.style.SUCCESS(f'[EMOJI] Compliance: {updated} records processed'))
            ...
            total_updated += updated
            self.stdout.write(self.style.SUCCESS(f'[EMOJI] Audit: {updated} records processed'))
            ...
            total_updated += updated
            self.stdout.write(self.style.SUCCESS(f'[EMOJI] Incident: {updated} records processed'))
            ...
            total_updated += updated
            self.stdout.write(self.style.SUCCESS(f'[EMOJI] Risk: {updated} records processed'))
            ...
            total_updated += updated
            self.stdout.write(self.style.SUCCESS(f'[EMOJI] RiskInstance: {updated} records processed'))
            ...
            total_updated += updated
            self.stdout.write(self.style.SUCCESS(f'[EMOJI] Event: {updated} records processed'))
            ...
            total_updated += updated
            self.stdout.write(self.style.SUCCESS(f'[EMOJI] Framework: {updated} records processed'))
            ...
            total_updated += updated
            self.stdout.write(self.style.SUCCESS(f'[EMOJI] SubPolicy: {updated} records processed'))

        if dry_run:
            self.stdout.write(self.style.WARNING(f'\nDRY RUN: Would update {total_updated} records'))
        else:
            self.stdout.write(self.style.SUCCESS(f'\n[EMOJI] Successfully updated {total_updated} records'))
