...
def get_total_audits(request):
    ...
    print(f"\n{'='*60}")
    print(f"[STATS] [TOTAL AUDITS IN DATABASE]")
    print(f"{'='*60}")
...
def get_open_audits(request):
    ...
    print(f"\n{'='*60}")
    print(f"[STATS] [OPEN AUDITS IN DATABASE]")
    print(f"{'='*60}")
    print(f"Framework ID: {framework_id}")
    print(f"Policy ID: {policy_id}")
...
def get_completed_audits(request):
    ...
    print(f"\n{'='*60}")
    print(f"[STATS] [COMPLETED AUDITS IN DATABASE]")
    print(f"{'='*60}")
    print(f"Framework ID: {framework_id}")
    print(f"Policy ID: {policy_id}")
...
def criticality_distribution(request):
    ...
    try:
        ...
        print(f"\n{'='*60}")
        print(f"[STATS] [CRITICALITY DISTRIBUTION] Chart")
        print(f"{'='*60}")
        print(f"Framework ID: {framework_id}")
        print(f"Policy ID: {policy_id}")
        ...
        if total_findings == 0:
            print(f"\n[WARNING] No findings found for these audits!")
            print(f"{'='*60}\n")
            return Response([{
                "criticality": level,
                "count": 0
...
def department_performance(request):
    ...
    try:
        ...
        print(f"\n{'='*60}")
        print(f"[STATS] [DEPARTMENT PERFORMANCE] Chart")
        print(f"{'='*60}")
        print(f"Framework ID: {framework_id}")
        print(f"Policy ID: {policy_id}")
        ...
        try:
            ...
            if audits_with_units.exists():
                ...
                print(f"[WARNING] No audits with business units found - returning empty result instead of mock data")
