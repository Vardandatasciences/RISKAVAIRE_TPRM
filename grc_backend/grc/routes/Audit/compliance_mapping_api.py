...
def map_document_to_compliance(request):
    ...
    try:
        ...
        logger.error(f"[ERROR] Error mapping document to compliance: {e}")
        return Response({
            'success': False,
...
def get_policy_compliance_summary(request, policy_id):
    ...
    try:
        ...
        logger.error(f"[ERROR] Error getting compliance summary: {e}")
        return Response({
            'success': False,
...
def map_audit_documents_to_compliance(request, audit_id):
    ...
    try:
        ...
        logger.error(f"[ERROR] Error mapping audit documents: {e}")
        return Response({
            'success': False,
...
def get_compliance_requirements(request, policy_id):
    ...
    try:
        ...
        try:
            ...
            logger.error(f"[ERROR] Error getting compliance requirements: {e}")
            return Response({
                'success': False,
...
def get_rule_based_compliance_mapping(document_text: str, document_type: str, 
    ...
    try:
        ...
        logger.error(f"[ERROR] Error in rule-based mapping: {e}")
        return {
            'mappings': [],
            'confidence': 0.0,
...
def get_basic_compliance_summary(policy_id: int, tenant_id: int) -> dict:
    ...
    try:
        ...
        logger.error(f"[ERROR] Error in basic summary: {e}")
        return {'error': str(e)}
...
def get_rule_based_multiple_document_mapping(documents: list) -> dict:
    ...
    try:
        ...
        logger.error(f"[ERROR] Error in rule-based multiple mapping: {e}")
        return {'error': str(e)}
